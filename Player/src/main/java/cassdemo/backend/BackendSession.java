...
public class BackendSessionPlayer {
	...
	private static PreparedStatement SELECT_BALL_POSITION;
	private static PreparedStatement SELECT_OPONENT_POSITION;
	private static PreparedStatement SELECT_CONFIG;
	private static PreparedStatement UPDATE_POSITION;
	...
	private void prepareStatements() throws BackendException {
		try {
			SELECT_BALL_POSITION = session.prepare("SELECT ;");
